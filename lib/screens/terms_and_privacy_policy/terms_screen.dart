    ...
    return const Scaffold(
      body: Column(
        children: [
          ...
          Text(
              "Anda bertanggung jawab penuh atas penggunaan aplikasi ini, dan Anda tidak akan menggunakan aplikasi ini untuk tujuan yang melanggar hukum atau merugikan pihak lain."),
          Text("2. Autentikasi"),
          Text(
